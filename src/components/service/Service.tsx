        ...
        <div className="w-[328px] h-[2334px] flex-col justify-start items-start gap-16 md:w-[960px] md:h-[1635px] md:gap-20 flex">
          ...
          <div className="flex-col justify-start items-start gap-10 inline-flex h-[1023px] w-[328px] md:h-[677px] md:w-[960px]">
            ...
            <div className="self-stretch md:self-auto h-[914px] md:h-auto flex-col justify-start items-start gap-10 md:gap-16 flex">
              <div className="self-stretch md:self-auto w-[328px] h-[449px] md:w-[960px] md:h-[264px] flex-col md:flex-row justify-start items-start gap-6 md:gap-16 flex">
                <Image
                  src="/Images/05.png"
                  alt="RareTECH"
                  width={400}
                ...
                <div className="md:grow md:shrink md:basis-0 md:flex-col md:justify-start md:items-start md:gap-10 md:inline-flex">
                  <div className="self-stretch  md:h-[168px] flex-col justify-start items-start gap-2 md:gap-6 flex">
                    <div className="text-[#FDFDFD] text-2xl font-bold font-['Noto Sans JP'] leading-9 tracking-wide">
                      ITスクール
                      <br />
                      RareTECH
                    </div>
                    <div className="self-stretch text-[#EEEEEE] text-base font-medium font-['Noto Sans JP'] leading-6 tracking-wide">
                      希少型エンジニアを育成するITスクールです。プログラミングに限らず、ネットワークやLinuxまで、徹底して基礎に拘るカリキュラムです。
                    </div>
                  </div>
                  <div className="w-60 h-14 px-8 py-4 bg-accent-100 rounded-full justify-center items-center inline-flex">
              ...
              <div className="self-stretch  md:self-auto h-[425px] md:h-auto md:w-[960px] flex-col md:flex-row justify-start items-start gap-16 flex md:inline-flex">
                <div className="flex-1 flex-col justify-start items-start gap-10 inline-flex">
                  <div className="self-stretch h-[144px] flex-col justify-start items-start gap-6 flex">
                    <div className="text-[#FDFDFD] text-2xl font-bold leading-9 tracking-wide">
                      インフラ学習サービス
                      <br />
                      エンベーダー
                    </div>
                    <div className="self-stretch text-[#EEEEEE] text-base font-medium leading-6 tracking-wide">
                  ...
                  <div className="w-[240px] px-8 py-4 bg-accent-100 rounded-full overflow-hidden justify-center items-center inline-flex">
                    <div className="flex-1 text-center text-[#212121] text-base font-bold leading-6 tracking-wide">
                      詳しく見る
                    </div>
                  </div>
                </div>
          ...
          <div className="flex-col justify-start items-start gap-10 flex">
            <div className="justify-start items-start gap-4 inline-flex">
              ...
              <div className="flex-col justify-start items-start inline-flex">
                <div className="text-[#FDFDFD] text-[32px] font-bold leading-[48px] tracking-wider">
                  Development
                </div>
                <div className="text-[#FDFDFD] text-sm font-bold leading-[21px] tracking-wide">
                  受託開発事業
                </div>
              </div>
            </div>
            <div className="flex-col justify-start items-start gap-16 flex">
              ...
              <div className="w-[960px] justify-start items-start gap-16 inline-flex">
                <div className="flex-1 flex-col justify-start items-start gap-10 inline-flex">
                  <div className="self-stretch h-[108px] flex-col justify-start items-start gap-6 flex">
                    <div className="text-[#FDFDFD] text-2xl font-bold leading-9 tracking-wide">
                      Web制作
                    </div>
                    <div className="self-stretch text-[#EEEEEE] text-base font-medium leading-6 tracking-wide">
